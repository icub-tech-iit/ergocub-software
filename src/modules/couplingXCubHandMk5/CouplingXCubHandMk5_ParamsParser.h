...
#define COUPLINGXCUBHANDMK5_PARAMSPARSER_H
...
/**
* This class is the parameters parser for class CouplingXCubHandMk5.
*
...
* | COUPLING_PARAMS | L0x                | vector<double> | -     | -             | 1        | x coordinate of the first end of the lever is  | The lenght of the list must be 5 |
* | COUPLING_PARAMS | L0y                | vector<double> | -     | -             | 1        | y coordinate of the first end of the lever is  | The lenght of the list must be 5 |
* | COUPLING_PARAMS | q2bias             | vector<double> | -     | -             | 1        | Angle of L1 - P1 when the finger is fully open | The lenght of the list must be 5 |
* | COUPLING_PARAMS | q1off              | vector<double> | -     | -             | 1        | Angle of P1 - P0 when the finger is closed     | The lenght of the list must be 5 |
* | COUPLING_PARAMS | k                  | vector<double> | -     | -             | 1        | Connecting rod length, L1-L0                   | The lenght of the list must be 5 |
* | COUPLING_PARAMS | d                  | vector<double> | -     | -             | 1        | Distance between the two joints, P1 and P0     | The lenght of the list must be 5 |
* | COUPLING_PARAMS | l                  | vector<double> | -     | -             | 1        | Distance between L1 and P1                     | The lenght of the list must be 5 |
* | COUPLING_PARAMS | b                  | vector<double> | -     | -             | 1        | Distance between L0 and P0                     | The lenght of the list must be 5 |
*
...
class CouplingXCubHandMk5_ParamsParser : public yarp::dev::IDeviceDriverParams
{
public:
    CouplingXCubHandMk5_ParamsParser();
    ~CouplingXCubHandMk5_ParamsParser() override = default;

public:
    const std::string m_device_classname = {"CouplingXCubHandMk5"};
    const std::string m_device_name = {"couplingXCubHandMk5"};
